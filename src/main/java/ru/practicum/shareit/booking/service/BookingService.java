...
public interface BookingService {
    ...
    List<BookingDto> getBookingsByBooker(long userId, String state, int from, int size);

    List<BookingDto> getBookingsByOwner(long userId, String state, int from, int size);
}
