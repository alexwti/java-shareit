...
class BookingRepositoryTest {
    ...
    void findBookingsLastTest() {
        ...
        Optional<Booking> res = bookingRepository.findFirstByItemIdAndEndBeforeOrderByStartDesc(item.getId(), LocalDateTime.now().plusHours(6));
    ...
    void findBookingsNextTest() {
        ...
        Optional<Booking> res = bookingRepository.findFirstByItemIdAndEndIsAfterOrderByStartAsc(item.getId(), LocalDateTime.now().plusHours(4));
